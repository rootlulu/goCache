...
const (
	...
	UserService_SetUser_FullMethodName  = "/proto.UserService/SetUser"
)
...
type UserServiceClient interface {
	...
	GetUsers(ctx context.Context, in *GetUserReq, opts ...grpc.CallOption) (*GetUsersResp, error)
	SetUser(ctx context.Context, in *GetUserReq, opts ...grpc.CallOption) (*GetUsersResp, error)
}
...
func (c *userServiceClient) GetUsers(ctx context.Context, in *GetUserReq, opts ...grpc.CallOption) (*GetUsersResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *userServiceClient) SetUser(ctx context.Context, in *GetUserReq, opts ...grpc.CallOption) (*GetUsersResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUsersResp)
...
type UserServiceServer interface {
	...
	GetUsers(context.Context, *GetUserReq) (*GetUsersResp, error)
	SetUser(context.Context, *GetUserReq) (*GetUsersResp, error)
...
func (UnimplementedUserServiceServer) GetUsers(context.Context, *GetUserReq) (*GetUsersResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUsers not implemented")
}
func (UnimplementedUserServiceServer) SetUser(context.Context, *GetUserReq) (*GetUsersResp, error) {
...
func _UserService_SetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).SetUser(ctx, req.(*GetUserReq))
	}
	return interceptor(ctx, in, info, handler)
}
